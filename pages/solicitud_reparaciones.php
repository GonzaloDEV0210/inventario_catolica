...
<body>
    ...
    <main>
        <h1 class="title title_compras">Solicitudes de Reparaciones</h1>
        <section class="container container_inputs">
            ...
            <div>
                ...
                <div>
                    <input type="date" id="fechaReparacion" placeholder="Seleccione" class="input_compras">
                </div>
            </div>
            <div>
        ...
        <section class="container container_buttons">
            ...
            <a href="../pages/reporte_reparaciones.php" target="_blank" rel="noopener noreferrer">
